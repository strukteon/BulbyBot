 ...
 *
 * Original Code: https://github.com/ikuza2/java-speech-api/blob/master/src/main/java/com/darkprograms/speech/translator/GoogleTranslate.java
 *
...
public final class GoogleTranslate { //Class marked as final since all methods are static
     ...
     */
    private final static String GOOGLE_TRANSLATE_URL = "http://translate.google.com/translate_tts";
     ...
     */
    public static String generateURL(String sourceLanguage, String targetLanguage, String text)
