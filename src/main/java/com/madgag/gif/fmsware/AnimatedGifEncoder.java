...
public class AnimatedGifEncoder {
  ...
  protected Color background = null;  // backgrounds color if given
  ...
  /**
   * Sets the backgrounds color for the last added frame
   * and any subsequent frames.
   * Since all colors are subject to modification
   * in the quantization process, the color in the final
   * palette for each frame closest to the given color
   * becomes the backgrounds color for that frame.
   * May be set to null to indicate no backgrounds color
   * which will default to black.
   *
   * @param c Color to be treated as backgrounds on display.
   */
  public void setBackground(Color c) {
	...
	protected void writeLSD() throws IOException {
		...
		out.write(0); // backgrounds color index
